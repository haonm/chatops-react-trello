...
const _excluded = ["id", "reducerData", "draggable", "laneDraggable", "laneDragClass", "style", "onDataChange", "onLaneScroll", "onCardClick", "onLaneClick", "onLaneAdd", "onCardDelete", "onCardAdd", "addLaneTitle", "editable", "canAddLanes"],
...
class BoardContainer extends _react.Component {
  constructor(...args) {
    ...
    (0, _defineProperty2.default)(this, "renderNewLane", () => {
      ...
      if (newLaneTemplate) {
        ...
        return /*#__PURE__*/_react.default.createElement(_NewLane.default, {
          onCancel: this.hideEditableLane,
          onAdd: this.addNewLane
        });
      }
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_Base.BoardDiv, (0, _extends2.default)({
      style: style
    }, otherProps, {
      draggable: false
      ...
      return draggable && laneDraggable ? /*#__PURE__*/_react.default.createElement(_Draggable.default, {
        key: lane.id
      }, laneToRender) : /*#__PURE__*/_react.default.createElement("span", {
        key: lane.id
      }, laneToRender);
    })), canAddLanes && /*#__PURE__*/_react.default.createElement(_Container.default, {
      orientation: "horizontal"
    }, editable && !addLaneMode ? /*#__PURE__*/_react.default.createElement(_Base.LaneSection, {
      style: {
        width: 200
      }
    }, /*#__PURE__*/_react.default.createElement(_Elements.NewLaneButton, {
